...
import { getAboutUser, getAllUsers, getConnectionRequests, getMyConnectionRequests, loginUser, registerUser } from "../../action/AuthAction";
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(getAllUsers.fulfilled,(state, action) => {
        state.isLoading = false;
        state.isError = false;
        state.all_profiles_fetching = false;  // <-- fixed
