...
function DashboardComponent() {
  ...
  // Fetch user and posts once token exists
  useEffect(() => {
        ...
        <DashboardLayout>
          ...
          {postState.postId !== "" && (
            ...
            >
              ...
              >
                {postState.comments[postState.postId]?.length === 0 && (
                  <h2>No Comments</h2>
                )}

                {postState.comments[postState.postId]?.length > 0 && (
                  <div>
                    {postState.comments[postState.postId].map((comment) => (
                      <div className={styles.singleComment} key={comment._id}>
                        ...
                        <p className={styles.singleComment_commentText}>
                          {comment.body}
                        </p>
                      </div>
                    ))}
